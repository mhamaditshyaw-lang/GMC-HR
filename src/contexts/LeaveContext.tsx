...
export function LeaveProvider({ children }: { children: ReactNode }) {
  const [leaveRequests, setLeaveRequests] = useState<LeaveRequest[]>([
    ...
    { id: 3, employeeName: 'Sarah Jenkins', type: 'Annual', start: '2026-04-20', end: '2026-04-22', status: 'Pending', reason: 'Personal' },
    { id: 4, employeeName: 'Mark Wilson', type: 'Sick', start: '2026-03-05', end: '2026-03-06', status: 'Pending', reason: 'Medical appointment' },
  ]);
